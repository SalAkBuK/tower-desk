...
export const PORTAL_MODULES: PortalModuleDefinition[] = [
    ...
    { key: "visitors", segment: "visitors", label: "Visitors", rule: { prefixes: ["visitors"] }, navGroup: "main", includeInHome: true, allowedRoles: ["admin", "org_admin", "building_admin", "manager"] },
    ...
    { key: "amenities", segment: "amenities", label: "Amenities", rule: { prefixes: ["buildings", "amenities", "building.amenities"] }, navGroup: "settings", includeInHome: true, allowedRoles: ["admin", "org_admin", "building_admin", "manager"] },
...
export const PORTAL_ROUTES: PortalRouteDefinition[] = [
    ...
    { id: "amenities-index", segments: ["amenities"], moduleKey: "amenities" },
